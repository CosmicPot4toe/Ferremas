...
def detalle_producto(request, id):
		...
		producto:Producto = get_object_or_404(Producto, id_producto=id)
		# Obtener la categoría asociada al producto
		categoria_producto:CategoriaProducto = producto.categoria
		categoria:Categoria = categoria_producto.categoria

		# Obtener todos los stocks para el producto
		stocks = Stock.objects.filter(producto=producto.id_producto)
